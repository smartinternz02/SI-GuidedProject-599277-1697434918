...
client = Cloudant.iam('92818d24-a178-43f1-8599-5eacce3e9240-bluemix','ozgIBUeeIg4XXzyG0KIie-q6gs2xCIZhhIm6IYTgXZiU', connect=True)
...
def afterlogin():
    ...
    if(len(docs.all())==0):
        return render_template('register.html', pred="The username is not found.")
    else:
...
def res():
    if request.method=="POST":
        ...
        x = np.array(img)  # Convert the image to numpy array
